...
import org.veupathdb.service.mblast.query.generated.model.TBlastNConfig
 ...
 */
fun TBlastNConfig.validate(errors: ErrorMap) {
  /*
  ...
  // task
  errors.validateWordSize(2, wordSize)
  // gapOpen
  // gapExtend
  errors.validateDBGenCode(dbGenCode)
  errors.validateMaxIntronLength(maxIntronLength)
  // matrix
  errors.validateThreshold(threshold)
  // compBasedStats
  // seg
