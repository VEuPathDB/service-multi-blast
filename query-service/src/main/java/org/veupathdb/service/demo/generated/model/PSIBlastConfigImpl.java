...
public class PSIBlastConfigImpl implements PSIBlastConfig {
  @JsonProperty("tool")
  ...
  private PSIBlastCompBasedStats compBasedStats;
  ...
  @JsonProperty("matrix")
  public PSIBlastMatrix getMatrix() {
    return this.matrix;
  }

  @JsonProperty("matrix")
  public void setMatrix(PSIBlastMatrix matrix) {
    this.matrix = matrix;
  }
  ...
  public PSIBlastCompBasedStats getCompBasedStats() {
  ...
  public void setCompBasedStats(PSIBlastCompBasedStats compBasedStats) {
