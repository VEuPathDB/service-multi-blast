...
@JsonDeserialize(
    as = DeltaBlastConfigImpl.class
)
public interface DeltaBlastConfig extends BlastQueryConfig {
  BlastQueryTool _DISCRIMINATOR_TYPE_NAME = BlastQueryTool.DELTABLAST;
  ...
  @JsonProperty("matrix")
  DeltaBlastMatrix getMatrix();

  @JsonProperty("matrix")
  void setMatrix(DeltaBlastMatrix matrix);
  ...
  DeltaBlastCompBasedStats getCompBasedStats();

  @JsonProperty(
      value = "compBasedStats",
      defaultValue = "comp-based-stats"
  )
  void setCompBasedStats(DeltaBlastCompBasedStats compBasedStats);
