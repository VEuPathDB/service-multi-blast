...
public class BlastXConfigImpl implements BlastXConfig {
  @JsonProperty("tool")
  ...
  private BlastXCompBasedStats compBasedStats;
  ...
  @JsonProperty("matrix")
  public BlastXMatrix getMatrix() {
    return this.matrix;
  }

  @JsonProperty("matrix")
  public void setMatrix(BlastXMatrix matrix) {
    this.matrix = matrix;
  }
  ...
  public BlastXCompBasedStats getCompBasedStats() {
  ...
  public void setCompBasedStats(BlastXCompBasedStats compBasedStats) {
