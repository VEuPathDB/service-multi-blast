...
class BlastPConfig : BlastQueryConfig() {

  override val tool: BlastQueryTool
    get() = BlastQueryTool.BlastP
  ...
  var compBasedStats: BlastPCompBasedStats? = null
