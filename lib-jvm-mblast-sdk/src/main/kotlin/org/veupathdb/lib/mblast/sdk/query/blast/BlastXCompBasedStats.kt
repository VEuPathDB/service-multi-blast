...
enum class BlastXCompBasedStats {
  None,
  CompBasedStats,
  ...
  companion object {
    ...
    @JvmStatic
    @JsonCreator
    fun fromJson(js: JsonNode): BlastXCompBasedStats {
      js.dEnumRequireTextual(BlastXCompBasedStats::class)
      return when (val v = js.textValue()) {
        ...
        else                                        -> throw UnrecognizedEnumException(BlastXCompBasedStats::class, v)
      }
    }
  }
}