...
enum class BlastPCompBasedStats {
  None,
  CompBasedStats,
  ...
  companion object {
    ...
    @JvmStatic
    @JsonCreator
    fun fromJson(js: JsonNode): BlastPCompBasedStats {
      js.dEnumRequireTextual(BlastPCompBasedStats::class)
      return when (val v = js.textValue()) {
        ...
        else                                        -> throw UnrecognizedEnumException(BlastPCompBasedStats::class, v)
      }
    }
  }
}