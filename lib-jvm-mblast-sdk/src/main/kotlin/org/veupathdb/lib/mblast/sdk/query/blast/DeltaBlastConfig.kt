...
class DeltaBlastConfig : BlastQueryConfig() {

  override val tool: BlastQueryTool
    get() = BlastQueryTool.DeltaBlast
  ...
  var matrix: DeltaBlastMatrix? = null
  ...
  var compBasedStats: DeltaBlastCompBasedStats? = null
  ...
  @get:JsonGetter("gapTrigger")
  @set:JsonSetter("gapTrigger")
