...
class BlastXConfig : BlastQueryConfig() {

  override val tool: BlastQueryTool
    get() = BlastQueryTool.BlastX
  ...
  var compBasedStats: BlastXCompBasedStats? = null
