...
val vJackson = "2.13.0" // FasterXML Jackson version
...
dependencies {
  ...
  constraints {
    ...
    api("org.veupathdb.lib:java-blast:4.0.0")
    ...
    runtime("com.fasterxml.jackson.module:jackson-module-kotlin:${vJackson}")
