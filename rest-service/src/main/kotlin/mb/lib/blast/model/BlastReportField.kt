...
enum class BlastReportField(val value: String) {
  /**
   * Query Seq-id
   */
  ...
  companion object {
    @JsonCreator
    fun fromString(value: String): BlastReportField {
      for (e in values())
      if (e.value == value)
        return e

      throw IllegalArgumentException(String.format(ErrorText.InvalidEnumValue, value, BlastReportField::class.simpleName))
    }
  }
}
