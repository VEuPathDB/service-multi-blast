...
import mb.api.model.blast.IOTBlastxConfig.Companion._DISCRIMINATOR_TYPE_NAME
...
data class IOTBlastxConfigImpl(
  ...
  override var queryGeneticCode: Byte? = null,
...
) : IOBlastConfigImpl(), IOTBlastxConfig {
  override val tool: BlastTool = _DISCRIMINATOR_TYPE_NAME
}