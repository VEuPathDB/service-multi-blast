...
import mb.api.model.blast.IOBlastpConfig.Companion._DISCRIMINATOR_TYPE_NAME
...
data class IOBlastpConfigImpl(
  ...
  override var task: BlastPTask? = null,
...
) : IOBlastConfigImpl(), IOBlastpConfig {
