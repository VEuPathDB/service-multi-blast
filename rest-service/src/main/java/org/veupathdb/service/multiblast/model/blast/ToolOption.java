...
public enum ToolOption
{
  ...
  InMultiSequenceAlignmentFile("in_msa"),
  InPSSMFile("in_pssm"),
  IPGList("ipglist"),
  ...
  NegativeGIList("negative_gilist"),
  NegativeIPGList("negative_ipglist"),
  NegativeSequenceIDList("negative_seqidlist"),
  NegativeTaxonomyIDs("negative_taxids"),
  NegativeTaxonomyIDList("negative_taxidlist"),
  ...
  OutputFile("out"),
  OutAsciiPSSM("out_ascii_pssm"),
  OutPSSM("out_pssm"),
  OutputFormat("outfmt"),
  ParseDefLines("parse_deflines"),
  PercentIdentity("perc_identity"),
  PhiPatternFile("phi_pattern"),
  PseudoCount("pseudocount"),
  Query("query"),
  QueryCoveragePerHSP("qcov_hsp_perc"),
  QueryGeneticCode("query_gencode"),
  QueryLocation("query_loc"),
  Remote("remote"),
  SaveEachPSSM("save_each_pssm"),
  SavePSSMAfterLastRound("save_pssm_after_last_round"),
  ScoringMatrix("matrix"),
  SearchSpaceEffectiveLength("searchsp"),
  SEGFilter("seg"),
  SequenceIDList("seqidlist"),
