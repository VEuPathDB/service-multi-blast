  ...
  public static TBlastnConfig fromSerial(ArrayNode node) {
    ...
    for (var i = 1; i < size; i++) {
      ...
      switch (ToolOption.fromString(curr.get(0).asText())) {
        ...
        case CompositionBasedStats -> out.setCompBasedStatisticsType(CompBasedStats.fromValue(curr.get(
          1).asText()));
        ...
        case InputPsiBlastCheckpointFile -> out.setPositionSpecificScoringMatrixFile(new File(curr.get(
          1).asText()));
        ...
        case NegativeTaxonomyIDs -> out.setNegativeTaxIds(Arrays.stream(curr.get(1).asText().split(
          ","))
        ...
        case ScoringMatrix -> out.setScoringMatrix(TBlastNScoringMatrix.unsafeFromString(curr.get(1).asText()));
        ...
        case Task -> out.setTask(TBlastNTask.fromString(curr.get(1).asText()));
        case TaxonomyIDs -> out.setTaxIDs(Arrays.stream(curr.get(1).asText().split(","))
          .mapToInt(Integer::parseInt)
          .toArray());
        ...
        case UngappedAlignmentOnly -> out.enableUngappedAlignmentOnly(curr.size() == 1
          || curr.get(1).asBoolean());
        case UseSmithWatermanAlignments -> out.enableSmithWatermanTraceback(curr.size() == 1
          || curr.get(1).asBoolean());
