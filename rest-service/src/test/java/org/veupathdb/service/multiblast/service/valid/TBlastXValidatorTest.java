...
import org.veupathdb.service.multiblast.generated.model.InputTBlastxConfigImpl;
import org.veupathdb.service.multiblast.model.ErrorMap;

import static org.junit.jupiter.api.Assertions.*;
import static org.veupathdb.service.multiblast.model.io.JsonKeys.*;
import static org.veupathdb.service.multiblast.model.io.JsonKeys.DBHardMask;

class TBlastXValidatorTest
{
  private ErrorMap          err;
  private InputTBlastxConfig conf;

  @BeforeEach
  void setUp() {
    err  = new ErrorMap();
    conf = new InputTBlastxConfigImpl();
  }

  @Nested
  @DisplayName("#validateSubjectLoc(ErrorMap, InputTBlastxConfig)")
  class ValidateSubjectLoc
  {
    ...
    class Null
    {
      ...
      void test1() {
        ...
        TBlastXValidator.validateSubjectLoc(err, conf);
  ...
  class ValidateTaxIds
  {
    ...
    void test1() {
      ...
      TBlastXValidator.validateTaxIds(err, conf);
      assertTrue(err.isEmpty());
    }
  ...
  class ValidateNegativeTaxIds
  {
    ...
    void test1() {
      ...
      TBlastXValidator.validateNegativeTaxIds(err, conf);
      assertTrue(err.isEmpty());
    }
  ...
  class ValidateBestHitScoreEdge
  {
    ...
    void test1() {
      TBlastXValidator.validateBestHitScoreEdge(err, conf);
      assertTrue(err.isEmpty());
    }
  ...
  class ValidateBestHitOverhang
  {
    ...
    void test1() {
      TBlastXValidator.validateBestHitOverhang(err, conf);
      assertTrue(err.isEmpty());
    }
  ...
  class ValidateCullingLimit
  {
    ...
    void test1() {
      TBlastXValidator.validateCullingLimit(err, conf);
      assertTrue(err.isEmpty());
    }
  ...
  class ValidateDbHardMask
  {
    ...
    void test1() {
      TBlastXValidator.validateDbHardMask(err, conf);
      assertTrue(err.isEmpty());
    }
  ...
  class ValidateDbSoftMask
  {
    ...
    void test1() {
      TBlastXValidator.validateDbSoftMask(err, conf);
      assertTrue(err.isEmpty());
    }
