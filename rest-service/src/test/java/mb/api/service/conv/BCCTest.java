...
class BCCTest
{
  ...
  class ToExternal1
  {
    ...
    void test1() {
      ...
      Assertions.assertEquals(Format.toHexString(pid), out.getId());
      Assertions.assertEquals(pos, out.getIndex());
    }
  }
  ...
  class ToExternal2
  {
    ...
    void test1() {
      ...
      Assertions.assertEquals(org, out.organism());
      Assertions.assertEquals(tgt, out.target());
    }
  }
  ...
  class ArrayToList
  {
    ...
    void test1() {
      ...
      Assertions.assertEquals(in.length, out.size());

      for (var i = 0; i < in.length; i++)
           Assertions.assertEquals(in[i], out.get(i));
    }

    @Test
    @DisplayName("Returns null on null input")
    void test2() {
      Assertions.assertNull(BCC.arrayToList(null));
    }
  }
  ...
  class ListToArray
  {
    ...
    void test1() {
      ...
      Assertions.assertEquals(in.size(), out.length);

      for (var i = 0; i < out.length; i++)
           Assertions.assertEquals(in.get(i), out[i]);
    }

    @Test
    @DisplayName("Returns null on null input")
    void test2() {
      Assertions.assertNull(BCC.listToArray(null));
    }
  }
  ...
  class NullToFalse
  {
    ...
    void test1() {
      Assertions.assertTrue(BCC.nullToFalse(true));
    }

    @Test
    @DisplayName("Returns false when input is false")
    void test2() {
      Assertions.assertFalse(BCC.nullToFalse(false));
    }

    @Test
    @DisplayName("Returns false when input is null")
    void test3() {
      Assertions.assertFalse(BCC.nullToFalse(null));
    }
  }
  ...
  class ToExternal3
  {
    ...
    void test1() {
      ...
      Assertions.assertEquals(in.getStart(), out.getStart());
      Assertions.assertEquals(in.getStop(), out.getStop());
    }

    @Test
    @DisplayName("Returns null on null input")
    void test2() {
      Assertions.assertNull(BCC.toExternal((Location) null));
    }
  }
  ...
  class ToExternal4
  {
    ...
    void test1() {
      ...
      Assertions.assertEquals(in.getWindow(), out.getWindow());
      Assertions.assertEquals(in.getHighCut(), out.getHicut());
      Assertions.assertEquals(in.getLowCut(), out.getLocut());
    }

    @Test
    @DisplayName("Returns null on null input")
    void test2() {
      Assertions.assertNull(BCC.toExternal((Seg) null));
    }
  }
  ...
  class ToInternal2
  {
    ...
    @DisplayName("Returns null on null input")
    void test2() {
      Assertions.assertNull(BCC.toInternal((IOBlastLocation) null));
    }
  }
  ...
  class ToInternal3
  {
    ...
    void test1() {
      ...
      Assertions.assertEquals(in.getWindow(), out.getWindow());
      Assertions.assertEquals(in.getHicut(), out.getHighCut());
      Assertions.assertEquals(in.getLocut(), out.getLowCut());
    }

    @Test
    @DisplayName("Returns null on null input")
    void test2() {
      Assertions.assertNull(BCC.toInternal((IOBlastSegMask) null));
    }
  }
}