...
class HashIDTest
{
  ...
  class HashToString1
  {
    ...
    void test1() {
      var in  = new byte[]{(byte) 255, 127, 31, 15, 0};
      var exp = "FF7F1F0F00";

      assertEquals(exp, HashID.hashToString(in));
    }
  }
  ...
  class StringToHash1
  {
    ...
    void test1() {
      var in  = "FF7F1F0F00";
      var exp = new byte[]{(byte) 255, 127, 31, 15, 0};
      var out = HashID.stringToHash(in);
    ...
    void test2() {
      var in  = "FF7F1F0F0";
      assertThrows(IllegalArgumentException.class, () -> HashID.stringToHash(in));
    }
  }
  ...
  class ByteToChar1
  {
    ...
    void test1() {
      ...
      for (var test : tests) {
        assertEquals(test[1], HashID.byteToChar(test[0]));
      }
    }
    ...
    void test2() {
      assertThrows(IllegalArgumentException.class, () -> HashID.byteToChar((byte) 16));
    }
  }
  ...
  class CharsToByte1
  {
    ...
    void test1() {
      ...
      for (var test : tests) {
        assertEquals(test[2], HashID.charsToByte(test[0], test[1]));
      }
    }
  }
  ...
  class CharToByte1
  {
    ...
    void test1() {
      ...
      for (var test : tests) {
        assertEquals(test[1], HashID.charToByte(test[0]));
      }
    }
    ...
    void test4() {
      assertThrows(IllegalArgumentException.class, () -> HashID.charToByte((byte) 'G'));
    }
  }
}