...
@JsonTypeName("blastx")
public class IOBlastxConfigImpl implements IOBlastxConfig
{
  ...
  private IOBlastxTask          task;
  private Integer               wordSize;
  private Integer               gapOpen;
  private Integer               gapExtend;
  private Integer               maxIntronLength;
  private IOBlastxScoringMatrix matrix;
  ...
  @JsonProperty("task")
  public IOBlastxTask getTask() {
    return this.task;
  }

  @JsonProperty("task")
  public void setTask(IOBlastxTask task) {
    this.task = task;
  }
  ...
  @JsonProperty("matrix")
  public IOBlastxScoringMatrix getMatrix() {
    return this.matrix;
  }

  @JsonProperty("matrix")
  public void setMatrix(IOBlastxScoringMatrix matrix) {
    this.matrix = matrix;
  }
