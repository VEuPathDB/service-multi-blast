...
class JobUtilTest
{
  ...
  class VerifyQuery
  {
    ...
    void test1() {
      assertThrows(BadRequestException.class, () -> JobUtil.verifyQuery(null));
    }
  ...
  class VerifyBody
  {
    ...
    @DisplayName("Throws an exception when the input is null")
    void test1() {
      assertThrows(BadRequestException.class, () -> JobUtil.verifyBody(null));
    }
  ...
  class VerifyProps
  {
    ...
    @DisplayName("Throws an exception when the input is null")
    void test1() {
      assertThrows(BadRequestException.class, () -> JobUtil.verifyProps(null));
    }
  ...
  class VerifyConfig
  {
    ...
    @DisplayName("Throws an exception when the input is null")
    void test1() {
      assertThrows(BadRequestException.class, () -> JobUtil.verifyConfig(null));
    }
  ...
  class NullCheck
  {
    ...
    void test1() {
      assertEquals("Hello", assertThrows(BadRequestException.class, () -> JobUtil.nullCheck(null, "Hello")).getMessage());
    }
