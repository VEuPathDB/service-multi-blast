...
internal class NegativeTaxIDListTest {

  @Nested
  @DisplayName("ParseNegTaxIDList()")
  inner class Parse {
    ...
    inner class NonString {
      ...
      fun t1() {
        assertThrows<IllegalArgumentException> {
          ParseNegTaxIDList(Json.new { put(FlagNegativeTaxIDList, 40) })
        }
      }
    }
    ...
    inner class Absent {
      ...
      fun t1() {
        assertTrue(ParseNegTaxIDList(Json.new {}).isDefault)
      }
    }
    ...
    inner class Present {
      ...
      fun t1() {
        val inp = Json.newObject { put(FlagNegativeTaxIDList, "bunny") }
        assertEquals("bunny", ParseNegTaxIDList(inp).file)
      }
    }
  }
  ...
  inner class Type {
    ...
    inner class NoArg {
      ...
      fun t1() {
        assertTrue(NegativeTaxIDList().isDefault)
      }
      ...
      fun t2() {
        ...
        NegativeTaxIDList().appendJson(inp)
      ...
      fun t3() {
        ...
        NegativeTaxIDList().appendCliSegment(inp)
      ...
      fun t4() {
        ...
        NegativeTaxIDList().appendCliParts(inp)
    ...
    inner class Arg {
      ...
      fun t1() {
        assertFalse(NegativeTaxIDList("bye.db").isDefault)
      }
      ...
      fun t2() {
        val inp = Json.newObject()
        NegativeTaxIDList("goop.txt").appendJson(inp)
        assertEquals("""{"$FlagNegativeTaxIDList":"goop.txt"}""", inp.toString())
      }
      ...
      fun t3() {
        ...
        NegativeTaxIDList("nope.nope.nope").appendCliSegment(inp)
        assertEquals(" $FlagNegativeTaxIDList 'nope.nope.nope'", inp.toString())
      }
      ...
      fun t4() {
        ...
        NegativeTaxIDList("yup.yup.yup").appendCliParts(inp)
        assertEquals(2, inp.size)
        assertEquals(FlagNegativeTaxIDList, inp[0])
