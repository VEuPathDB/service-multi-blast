...
internal class BlastPImplTest : BlastQueryWithIPGImplTest() {
  ...
  inner class BlastCLITask {
    ...
    inner class BlastCLITaskJson {
      ...
      fun t1() {
        ...
        tgt.task = BlastPTask(BlastPTaskType.BlastPShort)

        assertEquals(
          """
            {
              "tool" : "blastp",
              "$FlagTask" : "blastp-short"
            }
          """.trimIndent(),
    ...
    inner class BlastCLITaskCLIString {
      ...
      fun t1() {
        ...
        assertEquals("${tgt.tool.value} $FlagTask 'blastp-short'", tgt.toCliString())
      }
    }
    ...
    inner class BlastCLIToolCLIList {
      ...
      fun t1() {
        ...
        assertEquals("blastp-short", cli[2])
      }
    }
  }
  ...
  inner class BlastCLIMatrix {
    ...
    inner class BlastCLIMatrixJson {
      ...
      fun t1() {
        val tgt = getEmptyImpl()
        tgt.matrix = ScoringMatrixP(ScoringMatrixPType.Blosum45)
  ...
  inner class BlastCLICompBasedStats {
    ...
    inner class BlastCLICompBasedStatsJson {
      ...
      fun t1() {
        val tgt = getEmptyImpl()
        tgt.compBasedStats = CompBasedStatsP(CompBasedStatsPValue.UnconditionalScoreAdjustment)
  ...
  inner class BlastCLISoftMasking {
    ...
    inner class BlastCLISoftMaskingJson {
      ...
      fun t1() {
        val tgt = getEmptyImpl()
        tgt.softMasking = SoftMaskingP(true)
