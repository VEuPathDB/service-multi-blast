...
/**
 * Protein Query-Translated Subject BLAST 2.13.0+
 */
interface TBlastN : BlastQueryWithLists {
  ...
  fun task(value: TBlastNTaskType)
  ...
  fun matrix(value: ScoringMatrixTNType)
  ...
  fun compBasedStats(value: CompBasedStatsTNValue)
