...
internal class NegativeSeqIDListTest {

  @Nested
  @DisplayName("ParseNegSeqIDList()")
  inner class Parse {
    ...
    inner class NonString {
      ...
      fun t1() {
        assertThrows<IllegalArgumentException> {
          ParseNegSeqIDList(Json.new { put(FlagNegativeSeqIDList, 40) })
        }
      }
    }
    ...
    inner class Absent {
      ...
      fun t1() {
        assertTrue(ParseNegSeqIDList(Json.new {}).isDefault)
      }
    }
    ...
    inner class Present {
      ...
      fun t1() {
        val inp = Json.newObject { put(FlagNegativeSeqIDList, "bunny") }
        assertEquals("bunny", ParseNegSeqIDList(inp).file)
      }
    }
  }
  ...
  inner class Type {
    ...
    inner class NoArg {
      ...
      fun t1() {
        assertTrue(NegativeSeqIDList().isDefault)
      }
      ...
      fun t2() {
        ...
        NegativeSeqIDList().appendJson(inp)
      ...
      fun t3() {
        ...
        NegativeSeqIDList().appendCliSegment(inp)
      ...
      fun t4() {
        ...
        NegativeSeqIDList().appendCliParts(inp)
    ...
    inner class Arg {
      ...
      fun t1() {
        assertFalse(NegativeSeqIDList("bye.db").isDefault)
      }
      ...
      fun t2() {
        val inp = Json.newObject()
        NegativeSeqIDList("goop.txt").appendJson(inp)
        assertEquals("""{"$FlagNegativeSeqIDList":"goop.txt"}""", inp.toString())
      }
      ...
      fun t3() {
        ...
        NegativeSeqIDList("nope.nope.nope").appendCliSegment(inp)
        assertEquals(" $FlagNegativeSeqIDList 'nope.nope.nope'", inp.toString())
      }
      ...
      fun t4() {
        ...
        NegativeSeqIDList("yup.yup.yup").appendCliParts(inp)
        assertEquals(2, inp.size)
        assertEquals(FlagNegativeSeqIDList, inp[0])
