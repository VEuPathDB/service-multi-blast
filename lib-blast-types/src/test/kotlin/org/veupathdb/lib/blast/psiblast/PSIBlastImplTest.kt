...
internal class PSIBlastImplTest : BlastQueryWithIPGImplTest() {
  ...
  inner class BlastCLIMatrix {
    ...
    inner class BlastCLIMatrixJson {
      ...
      fun t1() {
        val tgt = getEmptyImpl()
        tgt.matrix = ScoringMatrixPSI(ScoringMatrixPSIType.Blosum45)
  ...
  inner class BlastCLICompBasedStats {
    ...
    inner class BlastCLICompBasedStatsJson {
      ...
      fun t1() {
        val tgt = getEmptyImpl()
        tgt.compBasedStats = CompBasedStatsPSI(CompBasedStatsPSIValue.UnconditionalScoreAdjustment)
  ...
  inner class BlastCLISoftMasking {
    ...
    inner class BlastCLISoftMaskingJson {
      ...
      fun t1() {
        val tgt = getEmptyImpl()
        tgt.softMasking = SoftMaskingPSI(true)
  ...
  @Nested
  @DisplayName(FlagInMSA)
  inner class BlastCLIInMSAFile {

    @Nested
    @DisplayName("when generating json output")
    inner class BlastCLIInMSAFileJson {

      @Test
      @DisplayName("appends the flag to the output json")
      fun t1() {
        val tgt = getEmptyImpl()
        tgt.inMSAFile = InMSAFile("hi")
        ...
        assertTrue(json.has(FlagInMSA))
        assertTrue(json[FlagInMSA].isTextual)
        assertEquals("hi", json[FlagInMSA].textValue())
      }
    }

    @Nested
    @DisplayName("when generating cli call strings")
    inner class BlastCLIInMSACLIString {
      ...
      fun t1() {
        ...
        assertEquals("${tgt.tool.value} $FlagInMSA 'hi'",
          tgt.toCliString())
      }
    }
  ...
  @Nested
  @DisplayName(FlagMSAMasterIndex)
  inner class BlastCLIMSAMasterIndex {

    @Nested
    @DisplayName("when generating json output")
    inner class BlastCLIMSAMasterIndexJson {

      @Test
      @DisplayName("appends the flag to the output json")
      fun t1() {
        val tgt = getEmptyImpl()
        tgt.msaMasterIndex = MSAMasterIndex(35u)
        ...
        assertTrue(json.has(FlagMSAMasterIndex))
        assertTrue(json[FlagMSAMasterIndex].isIntegralNumber)
        assertEquals(35, json[FlagMSAMasterIndex].intValue())
      }
    }

    @Nested
    @DisplayName("when generating cli call strings")
    inner class BlastCLIMSAMasterIndexCLIString {
      ...
      fun t1() {
        ...
        assertEquals("${tgt.tool.value} $FlagMSAMasterIndex 35", tgt.toCliString())
      }
    }
    ...
    inner class BlastCLIToolCLIList {
      ...
      fun t1() {
        ...
        assertEquals(3, cli.size)
        assertEquals(tgt.tool.value, cli[0])
        assertEquals(FlagMSAMasterIndex, cli[1])
        assertEquals("35", cli[2])
      }
    }
  }
  ...
  @Nested
  @DisplayName(FlagIgnoreMSAMaster)
  inner class BlastCLIIgnoreMSAMaster {

    @Nested
    @DisplayName("when generating json output")
    inner class BlastCLIIgnoreMSAMasterJson {

      @Test
      @DisplayName("appends the flag to the output json")
      fun t1() {
        val tgt = getEmptyImpl()
        tgt.ignoreMSAMaster = IgnoreMSAMaster(true)
        ...
        assertTrue(json.has(FlagIgnoreMSAMaster))
        assertTrue(json[FlagIgnoreMSAMaster].isBoolean)
        assertTrue(json[FlagIgnoreMSAMaster].booleanValue())
      }
    }

    @Nested
    @DisplayName("when generating cli call strings")
    inner class BlastCLIIgnoreMSAMasterCLIString {
      ...
      fun t1() {
        ...
        assertEquals("${tgt.tool.value} $FlagIgnoreMSAMaster",
          tgt.toCliString())
      }
    }
    ...
    inner class BlastCLIToolCLIList {
      ...
      fun t1() {
        ...
        assertEquals(2, cli.size)
        assertEquals(tgt.tool.value, cli[0])
        assertEquals(FlagIgnoreMSAMaster, cli[1])
      }
    }
  }
  ...
  inner class BlastCLIInPSSMFile {
    ...
    inner class BlastCLIInPSSMFileJson {
      ...
      fun t1() {
        ...
        assertTrue(json.has(FlagInPSSM))
        assertTrue(json[FlagInPSSM].isTextual)
        assertEquals("hi", json[FlagInPSSM].textValue())
      }
    }
    ...
    inner class BlastCLIInPSSMCLIString {
      ...
      fun t1() {
        ...
        assertEquals("${tgt.tool.value} $FlagInPSSM 'hi'",
          tgt.toCliString())
      }
    }
  ...
  @Nested
  @DisplayName(FlagPHIPattern)
  inner class BlastCLIPHIPatternFile {

    @Nested
    @DisplayName("when generating json output")
    inner class BlastCLIPHIPatternFileJson {

      @Test
      @DisplayName("appends the flag to the output json")
      fun t1() {
        val tgt = getEmptyImpl()
        tgt.phiPatternFile = PHIPatternFile("hi")
        ...
        assertTrue(json.has(FlagPHIPattern))
        assertTrue(json[FlagPHIPattern].isTextual)
        assertEquals("hi", json[FlagPHIPattern].textValue())
      }
    }

    @Nested
    @DisplayName("when generating cli call strings")
    inner class BlastCLIPHIPatternCLIString {
      ...
      fun t1() {
        ...
        assertEquals("${tgt.tool.value} $FlagPHIPattern 'hi'",
          tgt.toCliString())
      }
    }
    ...
    inner class BlastCLIToolCLIList {
      ...
      fun t1() {
        ...
        assertEquals(3, cli.size)
        assertEquals(tgt.tool.value, cli[0])
        assertEquals(FlagPHIPattern, cli[1])
        assertEquals("hi", cli[2])
      }
    }
  }
